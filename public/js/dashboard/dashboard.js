...
Component.options.__file = "resources/assets/js/components/Task-list.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b728b682", Component.options)
  } else {
    hotAPI.reload("data-v-b728b682", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        fetchTaskList: function fetchTaskList() {
            ...
            var archive = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
        ...
        createTask: function createTask() {
            ...
            axios.post('create_todo', this.task).then(function (result) {
                _this2.task.body = '';
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 5:
                                _context.next = 7;
                                return window.axios.post('edit_todo', task).then(function (result) {
                                    console.log('access!');
                                }).catch(function (err) {
                                    console.log(err);
                                });
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _context2.next = 2;
                                return window.axios.post('delete_todo/' + id).then(function (result) {
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                _context3.next = 2;
                                return window.axios.post('archive_todo/' + id).then(function (result) {
              ...
              return _c("div", { staticClass: "card" }, [
                _c("header", { staticClass: "card-header" }, [
                  _c("p", { staticClass: "card-header-title" }, [
                    _vm._v(" Milestones # " + _vm._s(task.id) + " ")
                  ]),
                  _vm._v(" "),
                  _c(
                    "a",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-b728b682", module.exports)
  }
}
